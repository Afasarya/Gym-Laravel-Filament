...
<body class="bg-black text-white">
    ...
    <main>
        ...
        <div class="flex-1 max-w-xs mx-2 text-center mb-4">
            <img src="" alt="" class="w-full rounded-lg mb-2 shadow-lg">
            <p class="text-white text-lg font-semibold"></p>
            <button onclick="toggleDescription('')" class="mt-2 text-blue-500 hover:underline">Show Description</button>
            <div id="description-" class="hidden text-white mt-2">
                <p></p>
            </div>
        </div>
    @endforeach
